...
int Solution_41::maxSubArray_2(vector<int>& nums) {
	...
	// the array consists of only positives and negatives, representing up and down trends
	// if the down trend is less than the up trend, it will finally lead to the maxmium
	// Pseudocode:
...
int Solution_41::maxSubArray_3(vector<int>& nums) {
	// write your code here

	// Carl:
	// Idea:
	// based on the idea in maxSubArray_2, where the idea is to compare the absolute value between the contiguous sum of positives and negatives
	// however, this method can only analyse local trend, but not global trend
	// here is the Kadane's algorithm, which adjust a little bit
	// the fundamental idea is that,
	// for any array [1, ..., n],
	// if subarray [i, ..., j] is the maxmium subarray,
	// then for any given k, the sum of array[i, ..., k] should be positive
	// Pseudocode:
